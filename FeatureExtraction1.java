...
File f1,f2;
File f = new File("D:\\SIGNATUREDATBASE\\Thinned_Skeletenized_match");
...
for(int class_no=0;class_no<DirinDir.length;class_no++)
 { 	 
  f1 = new File("D:\\SIGNATUREDATBASE\\Thinned_Skeletenized_match\\"+DirinDir[class_no]); 
  if(f1.isDirectory()) 
  {NoofClasses++;
  }
 }
...
for(int class_no=0,current_class=0;class_no<DirinDir.length;class_no++)
  { 	 
   ...
   {  
      ...
      {
      	f2=new File("D:\\SIGNATUREDATBASE\\Thinned_Skeletenized_match\\"+DirinDir[class_no]+"\\"+children[NoofFiles]);
...
WorkbookSettings ws = new WorkbookSettings();
 ...
 WritableWorkbook workbook = Workbook.createWorkbook(new File("D:\\SIGNATUREDATBASE\\FeatureExtracted_match.xls"), ws);
...
FeatureExtraction1 FeatureExtraction_obj=new FeatureExtraction1();
...
//Find global features for each class 
        ...
        global.addCell(new jxl.write.Label(4,0,"Expected person class"));
...
for(int class_no=0;class_no<DirinDir.length;class_no++)
  { 	 
   ...
   {  
      ...
      for(int NoofFiles=0;NoofFiles<children.length;NoofFiles++)
      {
        ...
        if(!children[NoofFiles].equals("Thumbs.db"))
         { 
          FeatureExtraction_obj.GlobalFeatures( global,"D:\\SIGNATUREDATBASE\\Thinned_Skeletenized_match\\"+DirinDir[class_no]+"\\"+children[NoofFiles],DirinDir[class_no],rowno);	    
	      rowno++;
         }
      }
    current_class ++;
  ...
  //Find texture features for each class 
        ...
        texture.addCell(new jxl.write.Label(4,0,"Expected person class"));
...
for(int class_no=0;class_no<DirinDir.length;class_no++)
  { 	 
   ...
   {  
      ...
      for(int NoofFiles=0;NoofFiles<children.length;NoofFiles++)
      {
        ...
        if(!children[NoofFiles].equals("Thumbs.db"))
         { 
          FeatureExtraction_obj.TextureFeatures( texture,"D:\\SIGNATUREDATBASE\\Thinned_Skeletenized_match\\"+DirinDir[class_no]+"\\"+children[NoofFiles],DirinDir[class_no],rowno);	    
	      rowno++;
         }
      }
    current_class ++;
  ...
  int blkn=((120*60)/(m1*n1));
   ...
   for( i=0;i<blkn;i++)     
   	...
   	grid_distance.addCell(new jxl.write.Label(i,0,"Expected person class"));
 ...
 i=0;
   for( i=0;i<blkn;i++)     
   	...
   	grid_angle.addCell(new jxl.write.Label(i,0,"Expected person class"));
  ...
  { 	 
   ...
   {  
      ...
      for(int NoofFiles=0;NoofFiles<children.length;NoofFiles++)
      {
        ...
        if(!children[NoofFiles].equals("Thumbs.db"))
         { 
          FeatureExtraction_obj.GridFeatures(grid_distance,grid_angle,m1,n1,"D:\\SIGNATUREDATBASE\\Thinned_Skeletenized_match\\"+DirinDir[class_no]+"\\"+children[NoofFiles],DirinDir[class_no],rowno);	    
	      rowno++;
         }
      }
    current_class ++;
