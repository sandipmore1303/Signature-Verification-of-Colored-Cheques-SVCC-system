...
public class MAIN_FeatureMatching_Global
...
Integer in=new Integer(constant_k);
	  WritableWorkbook workbook2= Workbook.createWorkbook(new File("D:\\SIGNATUREDATBASE\\KNNmatch_Global_k_"+in.toString()+".xls"));//for global features
	  WritableSheet knn;

	 knn = workbook2.createSheet("knn_Global",0);//for global
...
Integer in=new Integer(constant_k);
	  Workbook workbook_read0 = Workbook.getWorkbook(new File("D:\\SIGNATUREDATBASE\\KNNmatch_Global_k_"+in.toString()+".xls"));
      Sheet _1DMMC_alpha0,_1DMMC_red0,_1DMMC_green0,_1DMMC_blue0,_1DLDA_alpha0,_1DLDA_red0,_1DLDA_green0,_1DLDA_blue0;
...
*/
	...
	System.out.println("\n\t MATCHING ACCURAY of Global Feature based method is = "+((matchcount*100.0)/(totalnooffiles_to_Test)*1.0));
