...
public class MAIN_FeatureMatching_Texture
 ...
 */
      ...
      */
      ...
      Sheet sheet0=global0; //for global features
      ...
      **/
      ...
      Sheet sheet1=global1; //for global features




Integer in=new Integer(constant_k);
	  WritableWorkbook workbook2= Workbook.createWorkbook(new File("D:\\SIGNATUREDATBASE\\KNNmatch_Texture_k_"+in.toString()+".xls"));//for global features
	  WritableSheet knn;

	 knn = workbook2.createSheet("knn_Texture",0);//for global
	 no_of_features=4;//for global
...
Integer in=new Integer(constant_k);
	  Workbook workbook_read0 = Workbook.getWorkbook(new File("D:\\SIGNATUREDATBASE\\KNNmatch_Texture_k_"+in.toString()+".xls"));
      Sheet _1DMMC_alpha0,_1DMMC_red0,_1DMMC_green0,_1DMMC_blue0,_1DLDA_alpha0,_1DLDA_red0,_1DLDA_green0,_1DLDA_blue0;
...
*/
	...
	System.out.println("\n\t MATCHING ACCURAY of Texture Feature based method is = "+((matchcount*100.0)/(totalnooffiles_to_Test)*1.0));
