...
File f1,f2;
File f = new File("D:\\SIGNATUREDATBASE\\SIGNATUREDB");
 ...
 { 	 
  ...
  if(f1.isDirectory()) 
  {
  	try{
	    ...
	    strManyDirectories="D:\\SIGNATUREDATBASE\\Resized\\"+DirinDir[class_no];
		...
		if (success) {
			...
			strManyDirectories="D:\\SIGNATUREDATBASE\\BackgroundEliminated_Binarized\\"+DirinDir[class_no];
		...
		if (success) {
			...
			strManyDirectories="D:\\SIGNATUREDATBASE\\Size_Normalized\\"+DirinDir[class_no];
		...
		if (success) {
			...
			System.out.println("Directories: " + strManyDirectories + "not created");
				...
				strManyDirectories="D:\\SIGNATUREDATBASE\\Noise_Reduced\\"+DirinDir[class_no];
		...
		if (success) {
			...
			System.out.println("Directories: " + strManyDirectories + "not created");
				...
				strManyDirectories="D:\\SIGNATUREDATBASE\\Thinned_Skeletenized\\"+DirinDir[class_no];
...
preprocessing preprocessing_obj=new preprocessing();
...
for(int class_no=0;class_no<DirinDir.length;class_no++)
  { 	 
   ...
   {  
      ...
      for(int NoofFiles=0;NoofFiles<children.length;NoofFiles++)
      {
        ...
        if(!children[NoofFiles].equals("Thumbs.db"))
         { preprocessing_obj.ResizeImage("D:\\SIGNATUREDATBASE\\SIGNATUREDB\\"+DirinDir[class_no]+"\\"+children[NoofFiles],"D:\\SIGNATUREDATBASE\\Resized\\"+DirinDir[class_no]+"\\"+children[NoofFiles]);	    
  ...
  for(int class_no=0;class_no<DirinDir.length;class_no++)
  { 	 
   f1 = new File("D:\\SIGNATUREDATBASE\\Resized\\"+DirinDir[class_no]); 
   if(f1.isDirectory()) 
   {  
      String children[] = f1.list();  
      Arrays.sort(children);
      for(int NoofFiles=0;NoofFiles<children.length;NoofFiles++)
      {
      	f2=new File("D:\\SIGNATUREDATBASE\\Resized\\"+DirinDir[class_no]+"\\"+children[NoofFiles]);
        ...
        if(!children[NoofFiles].equals("Thumbs.db"))
         { 
	       ...
	       preprocessing_obj.Background_Elimination_binarization("D:\\SIGNATUREDATBASE\\Resized\\"+DirinDir[class_no]+"\\"+children[NoofFiles],"D:\\SIGNATUREDATBASE\\BackgroundEliminated_Binarized\\"+DirinDir[class_no]+"\\"+onlynameoffile);
  ...
  for(int class_no=0;class_no<DirinDir.length;class_no++)
  { 	 
   f1 = new File("D:\\SIGNATUREDATBASE\\BackgroundEliminated_Binarized\\"+DirinDir[class_no]); 
   if(f1.isDirectory()) 
   {  
      String children[] = f1.list();  
      Arrays.sort(children);
      for(int NoofFiles=0;NoofFiles<children.length;NoofFiles++)
      {
      	f2=new File("D:\\SIGNATUREDATBASE\\BackgroundEliminated_Binarized\\"+DirinDir[class_no]+"\\"+children[NoofFiles]);
                	    
         	 	
        if(!children[NoofFiles].equals("Thumbs.db"))
         { 
                    
	       preprocessing_obj.Noise_Reduction("D:\\SIGNATUREDATBASE\\BackgroundEliminated_Binarized\\"+DirinDir[class_no]+"\\"+children[NoofFiles],"D:\\SIGNATUREDATBASE\\Noise_Reduced\\"+DirinDir[class_no]+"\\"+children[NoofFiles]);
      ...
      for(int NoofFiles=0;NoofFiles<children.length;NoofFiles++)
      {
        ...
        if(!children[NoofFiles].equals("Thumbs.db"))
         { 
	       ...
	       preprocessing_obj.Thinning_Skeletonization("D:\\SIGNATUREDATBASE\\BackgroundEliminated_Binarized\\"+DirinDir[class_no]+"\\"+children[NoofFiles],"D:\\SIGNATUREDATBASE\\Thinned_Skeletenized\\"+DirinDir[class_no]+"\\"+children[NoofFiles]);
  ...
  for(int class_no=0;class_no<DirinDir.length;class_no++)
  { 	 
   f1 = new File("D:\\SIGNATUREDATBASE\\SIGNATUREDB_Thinned_Skeletenized\\"+DirinDir[class_no]); 
   if(f1.isDirectory()) 
   {  
      String children[] = f1.list();  
      Arrays.sort(children);
      for(int NoofFiles=0;NoofFiles<children.length;NoofFiles++)
      {
      	f2=new File("D:\\SIGNATUREDATBASE\\SIGNATUREDB_Thinned_Skeletenized\\"+DirinDir[class_no]+"\\"+children[NoofFiles]);
                	    
         	 	
        if(!children[NoofFiles].equals("Thumbs.db"))
         { 
                    
	       preprocessing_obj.Size_Normalization("D:\\SIGNATUREDATBASE\\SIGNATUREDB_Thinned_Skeletenized\\"+DirinDir[class_no]+"\\"+children[NoofFiles],"D:\\SIGNATUREDATBASE\\SIGNATUREDB_Size_Normalized\\"+DirinDir[class_no]+"\\"+children[NoofFiles]);
